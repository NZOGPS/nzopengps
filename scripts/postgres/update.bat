...
%nzogps_psql_bin%shp2pgsql -a -g the_geom -D -s4167 "..\..\LinzDataService\lds-nz-street-address-electoral-SHP\nz-street-address-electoral-3.shp"  nz-street-address-electoral > nz-street-address-3.sql
time /t
