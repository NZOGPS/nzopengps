...
set nzogps_osae=..\..\LinzDataService\lds-nz-street-address-CSV\nz-street-address.vrt
...
set nzogps_AIMS_AR=..\..\LinzDataService\lds-AIMS-address-reference-CSV\aims-address-reference.vrt
...
%nzogps_ogr2ogr% --config PG_USE_COPY TRUE -f "PostgreSQL" "PG:host=localhost user=postgres  dbname=nzopengps" -lco OVERWRITE=yes "%nzogps_osae%"
