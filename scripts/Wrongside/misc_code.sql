...
copy(select st_x(the_geom),st_y(the_geom),address,'Wrong Side: ' || id from "Northland-Nums" where asnum_roadid = isect_roadid and asnum_side*isect_side=-1) to 'C:\Gary\NZOGPS\nzopengps\scripts\Northland-Wrongside.csv' with CSV;
