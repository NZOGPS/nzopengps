...
def choose_tile(tile_reference)
  ...
  @tile = 'Central';@bounds = [-38.638100, 178.323730, -40.170971, 173.695114];@tileregion = 4
    when "5"
  @tile = 'Wellington';@bounds = [-40.170971, 176.974762, -41.703838, 174.56166];@tileregion = 5
    when "6"
  @tile = 'Tasman';@bounds = [-40.407970, 174.56166, -42.73194, 170.839737];@tileregion = 6
    when "7"
  @tile = 'Canterbury';@bounds = [-42.73194, 173.600006, -44.55553, 167.000000];@tileregion = 7
    when "8"
