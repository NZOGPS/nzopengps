...
cd SQLData
..\..\wrongside\mp_2_n_sql2.pl -c %nzogps_base%\%1.mp
cd ..
...
%nzogps_psqlc% -v ctable=%1_cities -v ntable=%1_numberlines -v mdist=10000 -v outfile='%nzogps_base%\scripts\suburbs\Outputs\%1-WrongCities10k.csv' -f Code\wrong3.sql
