...
if /i %1 equ Northland	%nzogps_psqlc% -c "drop table if exists %1_nums; Create table %1_Nums as select * from \"nz_street_address\" where gd2000_ycoord > -36.39;"
if /i %1 equ Auckland	%nzogps_psqlc% -c "drop table if exists %1_nums; Create table %1_Nums as select * from \"nz_street_address\" where gd2000_ycoord <-36.39 and gd2000_ycoord >-37.105228;"
