...
copy(select gd2000_xcoord,gd2000_ycoord,address,'Wrong Side: ' || id from :numstable where asnum_roadid = isect_roadid and asnum_side*isect_side=-1 order by id) to :outfile with CSV;
select current_time;
