...
%nzogps_psqlc% -v ctable=%1_cities -v ntable=%1_numberlines -v mdist=5000 -v outfile='%nzogps_base%\scripts\suburbs\Outputs\%1-WrongCities5k.csv' -f Code\wrong3.sql
