...
%nzogps_psqlc% -v ctable=%1_cities -v ntable=%1_numberlines -v mdist=200000 -v outfile='%nzogps_base%\scripts\suburbs\Outputs\%1-WrongCities200k.csv' -f Code\wrong3.sql
%nzogps_psqlc% -v ctable=%1_cities -v ntable=%1_numberlines -v mdist=100000 -v outfile='%nzogps_base%\scripts\suburbs\Outputs\%1-WrongCities100k.csv' -f Code\wrong3.sql
