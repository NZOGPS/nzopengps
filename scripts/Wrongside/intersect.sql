...
copy(select gd2000_xcoord,gd2000_ycoord,full_address,'Wrong Side: ' || address_id from :numstable where asnum_roadid = isect_roadid and asnum_side*isect_side=-1 order by address_id) to :outfile with CSV;
select current_time;
