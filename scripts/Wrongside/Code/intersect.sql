...
update :numstable set isect_side=1, isect_roadid=:linestable.gid from :linestable where road_id=linzid and ST_Intersects(nztm,rightpoly);
update :numstable set isect_side=-1, isect_roadid=:linestable.gid from :linestable where road_id=linzid and ST_Intersects(nztm,leftpoly);
